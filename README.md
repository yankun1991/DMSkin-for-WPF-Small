...
<h3>WPF无边框方案(单层窗体)</h3>
<h4>基于WPF的UI框架</h4>
<h4>方案思路:Windows消息 WM_GETMINMAXINFO + WM_SYSCOMMAND + AllowsTransparency="True" WindowStyle="None" </h4>
...
<p>【<a href='https://github.com/944095635' target="_blank">1.0版本</a>】采用WindowStyle.None + 透明实现无边框,版本缺陷是无边框通病，窗体最小化 动画失效了。但是我用xaml实现了动画(动画流畅程度取决于显卡),需要这个版本的源码请点击我的头像进到另外一个1.0项目中获取</p>
